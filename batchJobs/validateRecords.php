...
$processFile = 'validateRecordsProcess.php';
try {
    $cmd = 'php ';
    ...
    $pid = $process->getPid();
    echo "Validate Records Script has succeed to be executed: <b>".$email."</b>".PHP_EOL;
    echo $cmd;
} catch (Exception $exception) {
    echo $exception->getMessage();
    echo "Validate Records Script has failed to be executed: <b>".$email."</b>";
}
