...
$processFile = 'sendRFSDataProcess.php';
try {
    $cmd = 'php ';
    ...
    $pid = $process->getPid();
    echo "RFS Data Extract Script has succeed to be executed: <b>".$email."</b>".PHP_EOL;
    echo $cmd;
} catch (Exception $exception) {
    echo $exception->getMessage();
    echo "RFS Data Extract Script has failed to be executed: <b>".$email."</b>";
}
