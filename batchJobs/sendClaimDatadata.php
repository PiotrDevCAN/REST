...
$processFile = 'sendClaimDataProcess.php';
try {
    $cmd = 'php ';
    ...
    $pid = $process->getPid();
    echo "Claim Data Extract Script has succeed to be executed: <b>".$email."</b>".PHP_EOL;
    echo $cmd;
} catch (Exception $exception) {
    echo $exception->getMessage();
    echo "Claim Data Extract Script has failed to be executed: <b>".$email."</b>";
}
