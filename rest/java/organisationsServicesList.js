...
let OrganisationServiceEntry = await cacheBustImport('./organisationServiceEntry.js');

class organisationsServicesList {
    ...
    initialiseTable() {
        // DataTable
        this.table = $('#organisationServiceTable').DataTable({
            autoWidth: false,
            processing: true,
            responsive: false,
            dom: 'Blfrtip',
            ...
            ajax: {
                "url": "ajax/populateOrganisationServiceTable.php",
                "type": "GET",
            },
...
const OrganisationsServicesList = new organisationsServicesList();
OrganisationServiceEntry.table = OrganisationsServicesList.table;

export { OrganisationsServicesList as default };