...
$spreadsheet->getProperties()->setCreator('REST')
    ...
    ->setTitle('vBAC Claim Data Report')
    ->setSubject('vBAC Claim Data Report')
    ->setDescription('vBAC Claim Data Report generated by REST')
    ->setKeywords('office 2007 openxml php rest vbac claim data report')
    ->setCategory('vBAC Claim Data');
    // Add some data

$now = new DateTime();

try {
    $url = 'https://soiwapi-new.icds.ibm.com/Lloyds/api/vbacClaim/soEkCfj8zGNDLZ8yXH2YJjpehd8ijzlS/2021-01-01';
    ...
    if ($err) {
        // echo "cURL Error #:" . $err;
        throw new \Exception('vBAC Lloyds Claim API CURL call failed');
    } else {
    ...
    $subject = 'Error in: send vBAC Claim data ';
