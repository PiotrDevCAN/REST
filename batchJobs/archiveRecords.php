...
try {
    ...
    while($rowRFSData = sqlsrv_fetch_array($archivedRfsRs)){
        // get record data
        ...
        while ($rowRRData = sqlsrv_fetch_array($archievedResourceRequestsRs)){
            // get record data
            ...
            while ($rowRRHData = sqlsrv_fetch_array($archievedResourceRequestsHoursRs)){
                // get record data
            ...
            while ($rowRRDData = sqlsrv_fetch_array($archivedResReqDiaryRs)){                
                // get record data
                ...
                while ($rowADData = sqlsrv_fetch_array($archievedDiaryRs)){
                    // get record data
