...
$processFile = 'loadVBACActiveResourcesProcess.php';
try {
    $cmd = 'php ';
    ...
    $pid = $process->getPid();
    echo "Load VBAC Active Resources Script has succeed to be executed: <b>".$email."</b>".PHP_EOL;
    echo $cmd;
} catch (Exception $exception) {
    echo $exception->getMessage();
    echo "Load VBAC Active Resources Script has failed to be executed: <b>".$email."</b>";
}
