...
try {
    ...
    while($rowRFSData = sqlsrv_fetch_array($archivedRfsRs, SQLSRV_FETCH_ASSOC)){
        // get record data
        ...
        while ($rowRRData = sqlsrv_fetch_array($archievedResourceRequestsRs, SQLSRV_FETCH_ASSOC)){
            // get record data
            ...
            while ($rowRRHData = sqlsrv_fetch_array($archievedResourceRequestsHoursRs, SQLSRV_FETCH_ASSOC)){
                // get record data
            ...
            while ($rowRRDData = sqlsrv_fetch_array($archivedResReqDiaryRs, SQLSRV_FETCH_ASSOC)){                
                // get record data
                ...
                while ($rowADData = sqlsrv_fetch_array($archievedDiaryRs, SQLSRV_FETCH_ASSOC)){
                    // get record data
