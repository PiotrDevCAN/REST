...
$processFile = 'addMissingHoursProcess.php';
try {
    $cmd = 'php ';
    ...
    $pid = $process->getPid();
    echo "Add Missing RR Hours Script has succeed to be executed: <b>".$email."</b>".PHP_EOL;
    echo $cmd;
} catch (Exception $exception) {
    echo $exception->getMessage();
    echo "Add Missing RR Hours Script has failed to be executed: <b>".$email."</b>";
}
