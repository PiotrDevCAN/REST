...
$plannedOutages->defineOutage(new DateTime('2020-10-16'),"V2.3 Iteration Release. Implement 'Pipeline', Diary feature,Auto-Close,...  ");
$plannedOutages->defineOutage(new DateTime('2020-10-16'),"When there are planned outages to the app or it's supporting infrastructure, the details will be found here");
