...
<div class="alert alert-warning helplink">
  <strong>Unexpected Results ? </strong><br/>Please note only the <strong>Firefox</strong> browser is 100% supported for use with REST. If you experience an <strong>"unexpected result"</strong> and are NOT using Firefox, then please retry using Firefox before you escalate for support.
</div>
...
<textarea id='feedbackText' rows="4" cols="25" style='font-size:14px' placeholder="Type questions for the REST support team then click 'Send' below."></textarea>
</div>
</div>
<div class='row'>
