...
class staticValueStreamTable extends DbTable
{
    function returnForDataTables(){
        ...
        while($row = sqlsrv_fetch_array($rs, SQLSRV_FETCH_ASSOC)){
            ...
            $display['VALUE_STREAM'] .="<button type='button' class='btn btn-success btn-xs editRecord ".Navbar::$ACCESS_RESTRICT." ".Navbar::$ACCESS_ADMIN." ".Navbar::$ACCESS_CDI."' aria-label='Left Align' data-valuestream='" . $valueStream . "'>
                <span data-toggle='tooltip' class='glyphicon glyphicon-edit ' aria-hidden='true' title='Edit Record'></span>
            </button>";
            $display['VALUE_STREAM'] .="&nbsp;<button type='button' class='btn btn-danger btn-xs deleteRecord ".Navbar::$ACCESS_RESTRICT." ".Navbar::$ACCESS_ADMIN." ".Navbar::$ACCESS_DEMAND." ".Navbar::$ACCESS_CDI." ".Navbar::$ACCESS_RFS."' aria-label='Left Align' data-valuestream='" . $valueStream . "'>  
