...
function surpressMenuOptions(isAdmin, validUser, isItdq, isPmo){
	...
	surpressPmo = typeof isPmo !== 'undefined' ? !isPmo : true;
	...
	if(surpressPmo){
		console.log($('#dropDown_Define'));
		$('#dropDown_Define').remove();
	}
