...
$processFile = 'correctRRRecordsProcess.php';
try {
    $cmd = 'php ';
    ...
    $pid = $process->getPid();
    echo "Correct RR Records Script has succeed to be executed: <b>".$email."</b>".PHP_EOL;
    echo $cmd;
} catch (Exception $exception) {
    echo $exception->getMessage();
    echo "Correct RR Records Script has failed to be executed: <b>".$email."</b>";
}
